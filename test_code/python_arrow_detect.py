...
# URL로 이미지 파일 다운로드
# image_data = download_image("https://firebasestorage.googleapis.com/v0/b/diagramproject-f4e78.appspot.com/o/cropped_image__4654.png?alt=media&token=d388a758-4f2d-45a1-a889-ac8098a7ec3a")
...
for cnt in contours:
    ...
    if 6 > sides > 3 and sides + 2 == len(approx): #화살표의 경우
        ...
        for (existing_x, existing_y, existing_w, existing_h, _) in rec_XYWH:
            if is_inside(x, y, w, h, existing_x, existing_y, existing_w, existing_h):
